          ...
          <div className="calendar__film ">
            <a class="calendar__picture">
              ...
              >
                ...
                <div className="calendar__avgPoint">
                  <p className="calendar__point" style={{ display: 'inline' }}>{movie.danhGia}</p>
                  <p className="calendar__star" style={{ display: 'inline', marginLeft: '5px' }}>
            ...
            <div className="calendar__text">
              ...
              <div className="calendar_itemtext">
                ...
                <p className="calendar__time" style={{ textAlign: 'center' }}>
